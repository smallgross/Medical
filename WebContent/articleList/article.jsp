...
<meta http-equiv="Content-Type" content="text/html">
    ...
    <meta name="Keywords" content="复杂冠脉介入治疗研讨会">
    <meta name="Description" content="8月23日，由广东省介入性心脏病学会主办，中山大学附属第一医院心内科和南方医院心内科共同承办的“广州复杂冠脉介入治疗研讨会暨土金悦夫CTO介入课程2014” 在南方医院成功召开。本次研讨会特邀日本丰桥医院土金悦夫等国内外多位著名CTO介入专家现场进行手术演示和讨论等活动，包括省内各主要三甲医院主任在内近400人参加了此次盛会。">
...
<li class="nav-item">
    <div class="nav-item-tit" id="nav_jkjy"><a href="/yxzd/"  target="_self">医学指导</a></div>
    <ul class="nav-item-list">
        <li><a href="/yxzd/yxcs/" target="_self">医学常识</a></li>
        <li><a href="/yxzd/yfbj/" target="_self">预防保健</a></li>
        <li><a href="/yxzd/jbgl/" target="_self">疾病管理</a></li>
        <li><a href="/yxzd/yyzd/" target="_self">用药指导</a></li>
        <li><a href="/yxzd/kfzd/" target="_self">康复指导</a></li>
        <li class="nobline"><a href="/yxzd/jkft/" target="_self">健康访谈</a></li>
    </ul>
-->
</li>
<li class="nav-item">
...
<li class="nav-item">
    <div class="nav-item-tit" id="nav_xwzx"><a href="../Index1.html" target="_self">新闻中心</a></div>
    <ul class="nav-item-list">
       <!--  <li><a href="/xwzx/mzdt/simpleList.html" target="_self">门诊动态</a></li>-->
        <li><a href="../yygg/simplelist1.html" target="_self">医院公告</a></li>
        <li><a href="../yyxw1.html" target="_self">医院新闻</a></li>
        <li><a href="../mtny1.html" target="_self">媒体南医</a></li>
        <!--<li><a href="/xwzx/dzyk" target="_self">电子院刊</a></li>-->
        <!--<li><a href="/xwzx/nytk" target="_self">南医图库</a></li>>-->
...
<li class="nav-item">
    ...
    <ul class="nav-item-list">
        <!-- <li><a href="/nygy/gyhd" target="_self">公益活动</a></li>-->
        <li><a href="javascript:;" target="_self">骆老博客</a></li>
         <!--<li><a href="/nygy/dxjz" target="_self">大型救灾</a></li>
...
<!-- 
    <ul class="nav-item-list">
        <li><a href="/nyjy/" target="_self">导航</a></li>
        <li><a href="/nyjy/sy" target="_self">馨园</a></li>
        <li><a href="/nyjy/yz" target="_self">驿站</a></li>
        <li><a href="/nyjy/yy" target="_self">影院</a></li>
        <li><a href="/nyjy/st" target="_self">社团</a></li>
        <li><a href="/nyjy/hd" target="_self">活动</a></li>
        <li class="nobline"><a href="/nyjy/xz" target="_self">下载</a></li>
    </ul>
-->
</li>
...
<div class="header header_k clearfix">
    <span class="suoyin"><a href="../Index.html">首页</a> - <a href="../Index1.html" title="新闻中心" target="_self">新闻中心</a> - <a href="Index.html" title="医院新闻" target="_self">医院新闻</a></span>
    ...
    <div class="web_mainbox">
        <div class="web_left">
            ...
            <div class="art_box_c">
                ...
                <h1>${artile.title }</h1>
                 <div class="remark">作者：${artile.author }　2014-08-28 09:29  阅读量：22846</div>
                <div class="digest"><cite>[摘要]</cite>8月23日，由广东省介入性心脏病学会主办，中山大学附属第一医院心内科和南方医院心内科共同承办的“广州复杂冠脉介入治疗研讨会暨土金悦夫CTO介入课程2014” 在南方医院成功召开。本次研讨会特邀日本丰桥医院土金悦夫等国内外多位著名CTO介入专家现场进行手术演示和讨论等活动，包括省内各主要三甲医院主任在内近400人参加了此次盛会。</div> 
                <div class="art_con">
                   ${artile.content}
       </div>
                <div class="share-wrap"><!--分享-->
			<div class="weibo_fx">
				<script type="text/javascript" src="../html/js/nfyy_share1.js" charset="utf-8"></script>
				...
				$(function(){
					...
					<span class="art_weixin" weixin_share="1" title="打开微信，点击界面右上角魔术棒，选择“扫一扫”">
						<em title="微信"></em>
						<span class="art_weixin_ewm">
							<span class="ewm_bg"></span>
							<span class="ewm_box">
								<cite>分享到微信朋友圈</cite>
								<p>
									<span class="ewm_img" id="wx_Share_img"></span>
									<span class="ewm_text">“扫一扫”分享</span>
								</p>
							</span>
						</span>
					</span>
...
<div class="rbox">
    ...
    <ul class="news_rlist txtlist">
            	...
            	<li><a href="../yygg/a_1064181.html">南方医科大学南方医院征集荧光定量PCR仪及配套设备供应商公告（变更）</a></li>            	 
                
            	<li><a href="../yygg/a_1064171.html">南方医科大学南方医院增城分院征集生物安全柜供应商公告</a></li>            	 
                
            	<li><a href="../yygg/a_1064161.html">南方医科大学南方医院增城分院 负压隔离舱和红外线体温筛查仪紧急采购项目的公告</a></li>            	 
    ...
    <!--热点视频-->
     ...
     <div class="rbox hot-art">
				...
				<ul>
					...
					<li><i>1</i><span><a href="a_101174.html">胸心血管外科蔡开灿完成云南鲁甸抗震救灾任务凯旋</a></span></li> 
		  
					<li><i>2</i><span><a href="">心内科举办广州复杂冠脉介入治疗研讨会</a></span></li> 
		  
					<li><i>3</i><span><a href="a_101173.html">智发朝教授课题组在GIE上发表NOTES技术诊断不明原因腹水患者研究成果</a></span></li> 
		  
					<li><i>4</i><span><a href="a_101172.html">智发朝教授当选为中国健康促进基金会消化内镜发展专项基金管理委员会副主任委员</a></span></li> 
		  
					<li><i>5</i><span><a href="a_101175.html">谭万龙当选广东省泌尿生殖协会泌尿腹腔镜学分会首届委员会主任委员</a></span></li> 
